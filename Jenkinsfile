...
pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE_NAME = 'shivamkumar7493093/qbshop-app'
        DOCKER_MIGRATION_IMAGE_NAME = 'shivamkumar7493093/qbshop-migration'
    ...
    stages {
        ...
        stage('Clone Repository') {
            steps {
                script {
                    clone("https://github.com/ShivamJha97/Qualibytes-Ecommerce.git", "dev") 
                }
            }
        }
